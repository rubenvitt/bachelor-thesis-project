...
@Service
public class TimeCalculationService extends LoggableService {
    ...
    public static final DateTime getBeginOfWeek(Integer weekNumber) {
        if (weekNumber == null)
    ...
    public static final DateTime getEndOfWeek(Integer weekNumber) {
        if (weekNumber == null)
            weekNumber = DateTime.now().getWeekOfWeekyear();
        return getEndOfDay(new DateTime().withWeekOfWeekyear(weekNumber).dayOfWeek().withMaximumValue());
    }

    public static final DateTime getEndOfToday() {
        return getEndOfDay(DateTime.now());
    }

    public static final DateTime getBeginOfToday() {
    ...
    Interval searchTimeSlot(Collection<Interval> freeTimes, NewEventEntity newEventEntity) {
